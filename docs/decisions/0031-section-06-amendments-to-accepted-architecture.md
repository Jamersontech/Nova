...
the step Section 04's acceptance omitted. Had this ADR been rejected, every one of them would have
been removed and the accepted text restored verbatim.
...
(`AG-11`) and the explicit absence of a suspended state (`AG-12`). **Amendment status:** **Accepted** 2026-08-14.
...
only the enforcement claim is corrected. **Amendment status:** **Accepted** 2026-08-14.
...
**No new change class is created.** **Amendment status:** **Accepted** 2026-08-14.
...
**of**. **Amendment status:** **Accepted** 2026-08-14.
...
earlier, which is why it is enumerated rather than folded into an edit. **Amendment status:** **Accepted** 2026-08-14.
...
(approval substitution). `T-23a`'s residual is **not reduced**. **Amendment status:** **Accepted** 2026-08-14.
...
authority is created** — ADR 0023's three cover every event. **Amendment status:** **Accepted** 2026-08-14.
...
James accepted `0029`–`0031` together on 2026-08-14, so all thirteen amendments are accepted
